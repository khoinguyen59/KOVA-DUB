...
class ColabTtsRunner::Private final
{
public:
    ColabWorkerClient client;
};

ColabTtsRunner::ColabTtsRunner(QObject *parent)
    : QObject(parent), d(std::make_unique<Private>())
{
}

ColabTtsRunner::~ColabTtsRunner() = default;

void ColabTtsRunner::synthesize(const ColabTtsRequest &request)
{
    QString error;
