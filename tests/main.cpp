...
{
    if (LAStudio::isLiveDubbingStudioInvocation(argc, argv))
        return LAStudio::runLiveDubbingStudio(argc, argv);
    if (LAStudio::isLiveWorkflowInvocation(argc, argv))
        return LAStudio::runLiveWorkflow(argc, argv);
    ...
    {
        LAStudio::TestDubbingWorkspaceContract suite;
        runSuite(&suite, "TestDubbingWorkspaceContract");
    }
