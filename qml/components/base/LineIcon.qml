...
Canvas {
    ...
    onPaint: {
        ...
        if (name === "home") {
            ...
            circle(ctx, cx, cy, 8 * u)
            line(ctx, cx - 4 * u, cy, cx + 4 * u, cy)
            line(ctx, cx, cy - 4 * u, cx, cy + 4 * u)
        } else if (name === "clock") {
            circle(ctx, cx, cy, 8 * u)
            line(ctx, cx, cy - 4 * u, cx, cy)
            line(ctx, cx, cy, cx + 3 * u, cy + 2 * u)
            ...
            line(ctx, cx + 2 * u, cy - 9 * u, cx + 2 * u, cy - 4 * u)
            line(ctx, cx + 2 * u, cy - 4 * u, cx + 7 * u, cy - 4 * u)
            line(ctx, cx - 4 * u, cy - 1 * u, cx + 4 * u, cy - 1 * u)
            line(ctx, cx - 4 * u, cy + 3 * u, cx + 4 * u, cy + 3 * u)
            line(ctx, cx - 4 * u, cy + 6 * u, cx + 1 * u, cy + 6 * u)
        } else if (name === "arrow-left") {
            line(ctx, cx + 7 * u, cy, cx - 6 * u, cy)
            ctx.beginPath()
            ctx.moveTo(cx - 1 * u, cy - 5 * u)
            ctx.lineTo(cx - 7 * u, cy)
            ctx.lineTo(cx - 1 * u, cy + 5 * u)
            ctx.stroke()
        } else {
