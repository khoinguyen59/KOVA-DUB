...
- Runtime: https://github.com/CrispStrobe/CrispASR/releases/tag/v0.8.13
...
VoxCPM2 requires a CrispASR runtime with the `voxcpm2-tts` backend. LA Studio uses CrispASR v0.8.13 or newer for this model.
